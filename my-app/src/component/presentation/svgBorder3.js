...
class svgBorder3  extends Component {
    render(){

        return(<svg  style={{position:'absolute'}}   height={"100%"} width={"100%"} viewBox="0 0 596 727" preserveAspectRatio="none slice">
            <defs>
            ...
            <use x="586" y="10" xlinkHref="#c1"></use>
            <use x="586" y="717" xlinkHref="#c1"></use>
            <use x="10" y="717" xlinkHref="#c1"></use>
        </svg>)
    }
}
 export default svgBorder3;